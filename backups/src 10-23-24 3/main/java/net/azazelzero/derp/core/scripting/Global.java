...
//                PacketHandler.INSTANCE.send(PacketDistributor.PLAYER.with(() -> ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayerByName(player.toString())),new Message(new Packet(txt.toString())));
                    net.azazelzero.derp.core.net.PacketHandler.INSTANCE.send(PacketDistributor.PLAYER.with(() -> ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayerByName(player.toString())),new net.azazelzero.derp.core.net.Message(new Packet(txt.toString())));
