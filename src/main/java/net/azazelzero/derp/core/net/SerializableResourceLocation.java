...
public class SerializableResourceLocation extends ResourceLocation implements Comparable<ResourceLocation>, Serializable {
    ...
    protected SerializableResourceLocation(String[] p_135814_) {
        super(p_135814_);
    ...
    public SerializableResourceLocation(String p_135809_) {
        this(decompose(p_135809_, ':'));
    }
    public SerializableResourceLocation(String p_135811_, String p_135812_) {
        this(new String[]{p_135811_, p_135812_});
    }

    public static SerializableResourceLocation of(String p_135823_, char p_135824_) {
        return new SerializableResourceLocation(decompose(p_135823_, p_135824_));
    }

    @Nullable
    public static SerializableResourceLocation tryParse(String p_135821_) {
        try {
            return new SerializableResourceLocation(p_135821_);
    ...
    public static DataResult<ResourceLocation> read(String p_135838_) {
        try {
            return DataResult.success(new SerializableResourceLocation(p_135838_));
        } catch (ResourceLocationException ResourceLocationException) {
    ...
    public boolean equals(Object p_135846_) {
        if (this == p_135846_) {
            return true;
        } else if (!(p_135846_ instanceof SerializableResourceLocation)) {
            return false;
        } else {
            SerializableResourceLocation SerialiableResourceLocation = (SerializableResourceLocation)p_135846_;
            return this.namespace.equals(SerialiableResourceLocation.namespace) && this.path.equals(SerialiableResourceLocation.path);
        }
    }
    ...
    public int compareTo(SerializableResourceLocation p_135826_) {
    ...
    public int compareNamespaced(SerializableResourceLocation o) {
    ...
    public static SerializableResourceLocation read(StringReader p_135819_) throws CommandSyntaxException {
        int i = p_135819_.getCursor();

        while(p_135819_.canRead() && isAllowedInSerialiableResourceLocation(p_135819_.peek())) {
            p_135819_.skip();
        }
        ...
        try {
            return new SerializableResourceLocation(s);
        } catch (ResourceLocationException ResourceLocationException) {
    ...
    public static boolean isAllowedInSerialiableResourceLocation(char p_135817_) {
    ...
    public static boolean isValidSerialiableResourceLocation(String p_135831_) {
    ...
    public static class Serializer implements JsonDeserializer<SerializableResourceLocation>, JsonSerializer<SerializableResourceLocation> {
        public SerializableResourceLocation deserialize(JsonElement p_135851_, Type p_135852_, JsonDeserializationContext p_135853_) throws JsonParseException {
            return new SerializableResourceLocation(GsonHelper.convertToString(p_135851_, "location"));
        }

        public JsonElement serialize(SerializableResourceLocation p_135855_, Type p_135856_, JsonSerializationContext p_135857_) {
